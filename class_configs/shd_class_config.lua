...
local _ClassConfig = {
    ...
    ['DefaultConfig'] = {
        ...
        ['FlashHP']      = { DisplayName = "Flash HP", Category = "Combat", Tooltip = "What HP % to Activate Shield Flash", Default = 35, Min = 1, Max = 100, },
        ['StartBigTap']  = { DisplayName = "Use Big Taps", Category = "Spells and Abilities", Tooltip = "What HP % before we use Big Taps.", Default = 80, Min = 1, Max = 100, },
        ['StartLifeTap'] = { DisplayName = "Use Life Taps", Category = "Spells and Abilities", Tooltip = "What HP % before we use Life Taps.", Default = 100, Min = 1, Max = 100, },
